...
class Controller extends \Gcms\Controller
{
    ...
    public static function addCard(Request $request, $card, $login)
    {
        if ($login) {
            ...
            \Index\Home\Controller::renderCard($card, 'icon-exchange', $login['name'], number_format($items->pending), ' '.Language::get('ส่งมอบ', null, 0), 'index.php?module=borrow-setup&amp;status=');
