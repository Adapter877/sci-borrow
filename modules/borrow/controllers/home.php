...
class Controller extends \Gcms\Controller
{
    ...
    public static function addCard(Request $request, $card, $login)
    {
        if ($login) {
            ...
            \Index\Home\Controller::renderCard($card, 'icon-', $login['name'], number_format($items->returned), '{LNG_Borrow} &amp; {LNG_Return} {LNG_Un-Returned items}', 'index.php?module=borrow-setup&amp;status=2&amp;due=1');
