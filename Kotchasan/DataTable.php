...
class DataTable extends \Kotchasan\KBase
{
    ...
    public function render()
    {
        ...
        if ($this->showCaption) {
            ...
            $caption = str_replace(array(':search', ':count', ':start', ':end', ':page', ':total'), array($this->search, number_format($recordsTotal), number_format($s), number_format($e), number_format($this->page), number_format($totalpage)), $caption);
        }
